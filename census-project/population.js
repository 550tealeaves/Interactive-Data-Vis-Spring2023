...
d3.csv('../data/census_states_pcts.csv', d3.autoType).then(data => {
  ...
  const colorTotal = d3.scaleOrdinal()
    ...
    const colorTotalTwo = d3.scaleOrdinal()
  ...
  const colorMale = d3.scaleOrdinal()
        ...
        const colorMaleTwo = d3.scaleOrdinal()
            .domain(xScaleMale.domain())
  ...
  const colorFemale = d3.scaleOrdinal()
        ...
        const colorFemaleTwo = d3.scaleOrdinal()
            .domain(xScaleFemale.domain())
  ...
  svg.selectAll(".bar-total")
    ...
    .on('mouseover', function () {
                d3.select(this)
                    .attr("fill", d => colorTotal(d.FemEmpStat_Employed))
            })
            .on('mouseout', function () {
                d3.select(this)
                    .transition("colorfade")
                    .delay(100)
                    .attr("fill", d => colorTotalTwo(d.FemEmpStat_Employed))
            })
    .append("title")
  ...
  svgMale.selectAll(".bar-male")
    ...
    .on('mouseover', function () {
                d3.select(this)
                    .attr("fill", d => colorMale(d.FemEmpStat_Employed))
            })
            .on('mouseout', function () {
                d3.select(this)
                    .transition("colorfade")
                    .delay(100)
                    .attr("fill", d => colorMaleTwo(d.FemEmpStat_Employed))
            })
    .append("title")
    ...
    .on('mouseover', function () {
            ...
            .on('mouseout', function () {
                d3.select(this)
                    .transition("colorfade")
                    .delay(100)
                    .attr("fill", d => colorFemaleTwo(d.FemEmpStat_Employed))
            })
    .append("title")
