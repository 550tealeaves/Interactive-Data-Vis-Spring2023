...
d3.csv('../data/census.csv', d3.autoType)
    ...
    init();
        ...
        xScale = d3.scaleLinear()
            .domain([0, d3.max(state.data, d => d.TotalPop15andUp)]) //d3 max = function expecting an array - can pass in an accessor function
            .range([margin, width - margin])


        // yScale
        yScale = d3.scaleBand()
            .domain(state.data.map(d => d.Statistics))
    ...
    function draw() {
        ...
        d3.select(".value-sort").on("click", function () {
            ...
            yScale.domain(state.data.map(d => d.Statistics)) //(d => d.Statistics) replaces (function(d) {return d.Statistics;});
        ...
        const xScaleMale = d3.scaleLinear()
            .domain([0, d3.max(state.data, d => d.M_Pop15andUp)]) //d3 max = function expecting an array - can pass in an accessor function
            .range([margin, width - margin])
        ...
        d3.select(".value-sort-male").on("click", function () {
            ...
            yScaleMale.domain(state.data.map(d => d.Statistics)) //(d => d.Statistics) replaces (function(d) {return d.Statistics;});
        ...
        const xScaleFemale = d3.scaleLinear()
            .domain([0, d3.max(state.data, d => d.F_Pop15andUp)]) //d3 max = function expecting an array - can pass in an accessor function
            .range([margin, width - margin])
        ...
        d3.select(".value-sort-female").on("click", function () {
            ...
            yScaleFemale.domain(state.data.map(d => d.Statistics)) //(d => d.Statistics) replaces (function(d) {return d.Statistics;});
